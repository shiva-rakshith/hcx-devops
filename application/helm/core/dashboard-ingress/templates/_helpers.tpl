...
*/}}
{{- define "dashboard-ingress.fullname" -}}
...
*/}}
{{- define "dashboard-ingress.chart" -}}
...
*/}}
{{- define "dashboard-ingress.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "dashboard-ingress.fullname" .) .Values.serviceAccount.name }}
{{- else }}
