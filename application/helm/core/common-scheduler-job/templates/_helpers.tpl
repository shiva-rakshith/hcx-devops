...
*/}}
{{- define "common-scheduler-job.name" -}}
...
*/}}
{{- define "common-scheduler-job.fullname" -}}
...
*/}}
{{- define "common-scheduler-job.chart" -}}
...
*/}}
{{- define "common-scheduler-job.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "common-scheduler-job.fullname" .) .Values.serviceAccount.name }}
{{- else }}
